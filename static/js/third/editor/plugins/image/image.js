...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		var tabIndex = K.undef(options.tabIndex, 0),
		...
		var html = [
			...
			'<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + target + '" action="/upload">',
			//file
			'<div class="ke-dialog-row">',
		...
		var uploadbutton = K.uploadbutton({
			...
			afterError : function(html) {
                html = html.substring(html.indexOf('@_@')+3, html.indexOf('$_$'))
                    .replace("&lt;", "<").replace("&gt;", ">");
				dialog.hideLoading();
